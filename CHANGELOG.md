## [20.1.61] - 06/21/2022
**Bugs**
* Now, the date-time category axis interval will be calculated properly when zooming the chart.
* No exception will be thrown when zooming the chart with the date-time category axis.
* The single tap gesture for exploding will work properly now in the circular chart.
